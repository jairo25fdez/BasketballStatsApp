module.exports = function (app){
    ...
    app.delete(BASE_API_URL+"/player_stats_game", checkToken ,(request,response) =>{
    ...
    app.get(BASE_API_URL+"/player_stats_game", checkToken ,(request,response) =>{
    ...
    app.post(BASE_API_URL+"/player_stats_game", checkToken ,(request,response) =>{
        ...
        let player_stats = new Player_stats_game({
            ...
            player_number: player_stats_data.player_number,
    ...
    app.put(BASE_API_URL+"/player_stats_game", checkToken ,(request,response) =>{
    ...
    app.delete(BASE_API_URL+"/player_stats_game/:player_stats_id", checkToken ,(request,response) =>{
    ...
    app.get(BASE_API_URL+"/player_stats_game/:player_stats_id", checkToken ,(request,response) =>{
        var player_stats_id = request.params.player_stats_id;
    ...
    app.post(BASE_API_URL+"/player_stats_game/:play_id", checkToken ,(request,response) =>{
        response.sendStatus(405, "METHOD NOT ALLOWED ON A SPECIFIC CLUB.")
    });

    //PUT a specific Club in the database.
    app.put(BASE_API_URL+"/player_stats_game/:player_stats_id", checkToken ,(request,response) =>{
        ...
        Player_stats_game.findOne({_id: player_stats_id}, function (err, player_stats_data){
            if(isNull(player_stats_data)){
                ...
                player_stats_data.player_number = updatedData.player_number,
